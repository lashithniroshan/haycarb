...
const Home = () => {
  ...
  return (
    <div className="max-w-full mx-auto" style={{ minHeight: "100vh" }}>
      ...
      {isContentVisible && (
        <motion.div
          className="fixed top-1/4 left-2 z-50 flex flex-col items-center space-y-1 menuforitems"
          initial="visible"
              ...
              {index < array.length - 1 && (
                ...
                >
                  <div
                    ...
                    style={{
                      border: "1px solid rgba(122, 149, 184, 1)",
                      marginBottom: "1px",
                    }}
                  ></div>
                  <div
            ...
            <div>
              ...
              >
                <motion.button
                  ...
                  onClick={() =>
                    window.open(
                      "/pdf/Haycarb-PLC-Annual-Report-2024-25.pdf",
                      "_blank"
                    )
                  }
                  initial={{ opacity: 0, y: 50 }}
