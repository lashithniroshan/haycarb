...
const NumberedFeatureItem: React.FC<NumberedFeatureItemProps> = ({
  ...
  return (
    ...
    >
      <div className="flex-shrink-0 w-10 h-10 md:w-15 md:h-15 rounded-full bg-[#008DA8] text-white flex items-center justify-center font-bold text-xl md:text-4xl">
        {number}
      </div>
